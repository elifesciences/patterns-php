...
module.exports = /*#__PURE__*/_createClass(function AboutProfiles($elm) {
  var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
  var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
  _classCallCheck(this, AboutProfiles);
  if (!$elm) {
    return;
  }
  this.$elm = $elm;
  ...
  [].forEach.call(this.$elm.querySelectorAll('li'), function (item) {
...
module.exports = /*#__PURE__*/function () {
  function AnnotationTeaser($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, AnnotationTeaser);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
  ...
  return _createClass(AnnotationTeaser, [{
    key: "createLink",
    value: function createLink(uri) {
      if (!uri || typeof uri !== 'string') {
        return;
      }
      var $a = utils.buildElement('a', ['annotation-teaser__link']);
      var rootChildren = [].slice.call(this.$elm.childNodes);
      [].forEach.call(rootChildren, function (node) {
        $a.appendChild(node);
      });
    ...
    key: "showAsReply",
    value: function showAsReply(text) {
      if (!text || typeof text !== 'string') {
        return;
      }
      var $parent = this.$elm.querySelector('.annotation-teaser__reply');
      utils.buildElement('span', ['annotation-teaser__reply_cta'], text, $parent);
    }
  }]);
}();

},{"../libs/elife-utils":49}],3:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  function ArticleDownloadLinksList($elm) {
    ...
    this.$buttonWrapper = this.doc.querySelector('.side-section-wrapper__list') || this.doc.querySelector('.button-collection--inline');
    if (!this.$buttonWrapper) {
      return;
    }
    this.$downloadLink = this.$buttonWrapper.querySelector('.side-section-wrapper__download_link') || this.doc.getElementById('button-action-download');
    ...
    this.hideJsExcludes();
    this.$toggler = this.doc.querySelector('.side-section-wrapper__download_link') || this.doc.getElementById('button-action-download');
    this.moveList();
   ...
   */
  return _createClass(ArticleDownloadLinksList, [{
    key: "hideJsExcludes",
    value: function hideJsExcludes() {
      [].forEach.call(this.$elm.querySelectorAll('.article-download-links-list__group--js-exclude'), function ($group) {
...
},{"../libs/elife-utils":49}],4:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(ArticleSection, [{
    key: "initialise",
    ...
    key: "createToggle",
    value: function createToggle($elm, doc) {
    ...
    key: "setInitialState",
    value: function setInitialState($elm, $toggle, $body) {
      var hash = '';
    ...
    value: function expand(e) {
      ...
      try {
        if (e.detail.search(/https?:\/\//) !== 0) {
          var $descendentEl = this.doc.getElementById(e.detail);
          if (!!$descendentEl) {
...
},{"../libs/elife-utils":49}],5:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(Assessment, [{
    key: "assessmentToggle",
    value: function assessmentToggle() {
      var assessment = this.$elm.querySelector('.assessment__container');
      var assessmentWrapper = document.querySelector('.assessment__wrapper');
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function AssetNavigation($elm) {
    var _this = this;
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, AssetNavigation);
    this.$elm = $elm;
    this.window = _window;
    this.doc = doc;
    this.assetItems = [];
    var promise;
    var $seeAll = this.$elm.querySelector('.asset-viewer-inline__header_link');
    if ($seeAll) {
      promise = utils.remoteDoc($seeAll.href, this.window).then(function (doc) {
        var $newAsset = doc.querySelector("#".concat(_this.$elm.id)); // No getElementById() as this might be a remote doc.
        if (!$newAsset) {
          return [_this.$elm];
        }
        var $newSupplements = doc.querySelectorAll("[data-parent-asset-id=\"".concat(_this.$elm.id, "\"]"));

        // Avoid circular behaviour.
        var dataset = $newAsset.dataset.behaviour.trim().split(' ');
        var index = dataset.indexOf('AssetNavigation');
        dataset.splice(index, 1);
        $newAsset.dataset.behaviour = dataset.join(' ');
        _this.$elm.parentNode.replaceChild($newAsset, _this.$elm);
        _this.$elm = $newAsset;
        var assetItems = [_this.$elm];
        var _iterator = _createForOfIteratorHelper($newSupplements),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var supplement = _step.value;
            assetItems.push(supplement);
            _this.$elm.parentNode.insertBefore(supplement, _this.$elm.nextSibling);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      promise = Promise.resolve().then(function () {
        return [_this.$elm].concat(_toConsumableArray(_this.findSupplements()));
      });
    }
    promise = promise.then(function (assetItems) {
      _this.assetItems = assetItems;
      if (_this.assetItems.length > 1) {
        var hash = _this.window.location.hash.substring(1);
        var show = 0;
        [].forEach.call(_this.assetItems, function (assetItem, i) {
          var navigation = utils.buildElement('div', ['asset-viewer-inline__header_navigation'], '', assetItem.querySelector('.asset-viewer-inline__header_panel'), '.asset-viewer-inline__header_text');
          if (assetItem.id === hash) {
            show = i;
          }
          _this.addPreviousButton(i, navigation);
          _this.addNextButton(i, navigation);
          assetItem.addEventListener('assetViewerFocus', function () {
            return _this.show(i);
          });
        });
        _this.show(show);
        _this.window.addEventListener('hashchange', _this.hashChange.bind(_this));
      }
    });
  }
  return _createClass(AssetNavigation, [{
    key: "addPreviousButton",
    value: function addPreviousButton(i, navigation) {
      var _this2 = this;
      var previous = utils.buildElement('span', ['asset-viewer-inline__previous'], '', navigation);
      if (i > 0) {
        previous.addEventListener('click', function () {
          _this2.window.history.pushState(null, '', '#' + _this2.assetItems[i - 1].id);
          _this2.show(i - 1);
        });
    ...
    key: "addNextButton",
    value: function addNextButton(i, navigation) {
      var _this3 = this;
      var next = utils.buildElement('span', ['asset-viewer-inline__next'], '', navigation);
      if (i < this.assetItems.length - 1) {
        next.addEventListener('click', function () {
          _this3.window.history.pushState(null, '', '#' + _this3.assetItems[i + 1].id);
          _this3.show(i + 1);
        });
    ...
    value: function hideAll() {
      [].forEach.call(this.assetItems, function (assetItem) {
        return assetItem.classList.add('visuallyhidden');
      });
    }
  }, {
    key: "show",
    ...
    key: "findSupplements",
    value: function findSupplements() {
      return this.doc.querySelectorAll("[data-parent-asset-id=\"".concat(this.$elm.id, "\"]"));
    }
  }, {
    key: "hashChange",
    value: function hashChange(e) {
      ...
      [].forEach.call(this.assetItems, function (assetItem, i) {
        if (assetItem.id === hash) {
          _this4.show(i);
...
},{"../libs/elife-utils":49}],7:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(AssetViewer, [{
    key: "handleClick",
    value: function handleClick(e) {
      ...
      [].forEach.call(assets, function (asset, i) {
        var caption = asset.querySelector('.caption-text__heading');
        var item = {
      ...
      var gallery = new PhotoSwipe(document.querySelector('.pswp'), PhotoSwipeUI_Default, items, options); // jshint ignore:line

      // jscs:enable

      gallery.init();
      gallery.listen('beforeChange', function () {
        var asset = _this.findAssets()[gallery.getCurrentIndex()];
        var event = utils.eventCreator('assetViewerFocus');
        asset.dispatchEvent(event);
      });
    }
  }, {
    key: "findAssets",
    value: function findAssets() {
      return this.doc.querySelectorAll("[data-asset-viewer-group=\"".concat(this.$elm.dataset.assetViewerGroup, "\"]"));
    }
  }, {
    key: "setup",
    value: function setup(doc) {
      var _this2 = this;
      AssetViewer.load(doc).then(function () {
        var assetLink = _this2.$elm.querySelector('.captioned-asset__link');
        var openLink = _this2.$elm.querySelector('.asset-viewer-inline__open_link');
        if (assetLink) {
          assetLink.addEventListener('click', _this2.handleClick.bind(_this2));
        }
        if (openLink) {
          openLink.addEventListener('click', _this2.handleClick.bind(_this2));
        }
      });
    }
  }], [{
    ...
    value: function load(doc) {
      if (!this.loader) {
        this.loader = Promise.all([utils.loadJavaScript('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/photoswipe.min.js', 'sha384-QELNnmcmU8IR9ZAykt67vGr9/rZJdHbiWi64V88fCPaOohUlHCqUD/unNN0BXSqy'), utils.loadJavaScript('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/photoswipe-ui-default.min.js', 'sha384-m67o7SkQ1ALzKZIFh4CiTA8tmadaujiTa9Vu+nqPSwDOqHrDmxLezTdFln8077+q'), utils.loadStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/photoswipe.min.css', 'sha384-h/L2W9KefUClHWaty3SLE5F/qvc4djlyR4qY3NUV5HGQBBW7stbcfff1+I/vmsHh'), utils.loadStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/default-skin/default-skin.min.css', 'sha384-iD0dNku6PYSIQLyfTOpB06F2KCZJAKLOThS5HRe8b3ibhdEQ6eKsFf/EeFxdOt5R')]);
...
},{"../libs/elife-utils":49}],8:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(AudioPlayer, [{
    ...
    value: function prepare$title(parent, doc) {
      ...
      var link = span.querySelector('.audio-player__header-link');
      if (link) {
        this.$titleLink = link;
        return link;
      }
     ...
     */
    function togglePlay($audioElement, $togglePlayButton) {
      if (this.isPlaying) {
    ...
    value: function update() {
      ...
      this.$progressBar.style.width = "".concat(pc, "%");
    ...
    value: function changeChapter(number, title, $elm) {
      ...
      var chapterChanged;
      try {
        chapterChanged = new CustomEvent('chapterChanged', {
          detail: number
        });
      } catch (e) {
        // CustomEvent not supported, do it the old fashioned way
        chapterChanged = document.createEvent('chapterChanged');
        chapterChanged.initCustomEvent('chapterChanged', true, true, {
          detail: number
        });
      }
     ...
     * @param chapterTitle
     */
    function setTitle(episodeTitle, chapterTitle) {
    ...
    value: function buildPlayButton(player) {
      return utils.buildElement('button', ['audio-player__toggle_play'], 'Play', '#' + player.uniqueId + ' [class*="audio-player"]', true);
    }
...
},{"../libs/elife-utils":49}],9:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  function Authors($elm) {
    ...
    if (this.authors.length > this.authorLimits[0]) {
      ...
      this.authorLimits.map(function (limit) {
        if (limit < _this.authors.length) {
          _this.$elm.classList.add("authors--limit-".concat(limit));
        }
      });
    }
  ...
  return _createClass(Authors, [{
    ...
    value: function handleResize() {
      ...
      this.addTrailingText('author', this.authors);
      var toggles = this.$elm.querySelectorAll('.item_toggle .author_link_highlight');
      var updateToggleText = this.getUpdatedToggleText.bind(this);
    ...
    key: "hideExcessItems",
    value: function hideExcessItems(itemType, items) {
    ...
    key: "getAuthorsCount",
    value: function getAuthorsCount() {
    ...
    value: function markLastNonExcessItem(itemType, items) {
      ...
      [].forEach.call(items, function (item, i) {
        ...
        if (item.querySelector('.' + itemType)) {
          item.querySelector('.' + itemType).classList.remove(itemType + '--last-non-excess');
      ...
      if (lastShownIndex !== null && lastShownIndex > -1) {
        var lastShown = items[lastShownIndex].querySelector('.' + itemType);
        if (lastShown) {
    ...
    key: "getToggleCollapsedText",
    value: function getToggleCollapsedText() {
      var baseText = '<span class="visuallyhidden"> expand author list</span>';
      if (this.window.matchMedia('(min-width: 730px)').matches) {
        return "".concat(baseText, "<span aria-hidden=\"true\">see&nbsp;all</span>");
      }
      return "et al.".concat(baseText);
    }
  }, {
    key: "getToggleExpandedText",
    value: function getToggleExpandedText() {
      var baseText = '<span class="visuallyhidden"> collapse author list</span>';
      return "".concat(baseText, "<span aria-hidden=\"true\">see&nbsp;less</span>");
    }
  }, {
    key: "getUpdatedToggleText",
    value: function getUpdatedToggleText(newState) {
    ...
    value: function updateToggleState(newState, toggle, itemType) {
      ...
      if (newState === 'expanded') {
        this.$elm.querySelector(".".concat(itemType, "_list")).classList.add("".concat(itemType, "_list--expanded"));
      } else {
        this.$elm.querySelector(".".concat(itemType, "_list")).classList.remove("".concat(itemType, "_list--expanded"));
      }
    }
    ...
    value: function buildSeeMoreLessToggle(itemType) {
      var _this3 = this;
      var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'collapsed';
      var $toggleWrapper = utils.buildElement('li', ['item_toggle', 'item_toggle--' + state, 'item_toggle--' + itemType], '', this.$elm.querySelector('.' + itemType + '_list'));
      $toggleWrapper.setAttribute('aria-hidden', 'true');
      var $toggle = utils.buildElement('button', ['author_link_highlight'], this.getUpdatedToggleText(state), $toggleWrapper);
      var handleSeeMoreLessPress = function handleSeeMoreLessPress(e) {
        e.preventDefault();
        var $toggleWrapper = e.currentTarget.parentNode;
        var newState;
        if ($toggleWrapper.classList.contains('item_toggle--collapsed')) {
          ...
          if (itemType === 'institution') {
            _this3.hideAllExcessItems();
          }
          newState = 'collapsed';
        }
        _this3.updateToggleState(newState, e.currentTarget, itemType);
      };
    ...
    value: function hideAllExcessItems() {
...
},{"../libs/elife-utils":49}],10:[function(require,module,exports){
'use strict';
...
var MONTHLY_TICK = 3600 * 1000 * 24 * 30;
var WEEKLY_TICK = 3600 * 1000 * 24 * 7;
var defaultOptions = {
  chart: {
    type: 'column'
  },
  ...
  tooltip: {
    ...
    formatter: function formatter() {
      return "\n            <div class=\"chart-tooltip\">\n              <div class=\"chart-tooltip__header\">\n                ".concat(this.y, " ").concat(this.points[0].series.chart.options.title.text, "\n              </div>\n              <div class=\"chart-tooltip__content\">\n                ").concat(Highcharts.dateFormat('%b %d, %Y', new Date(this.x)), "\n              </div>\n            </div>\n          ");
    }
  },
  plotOptions: {
    column: {
...
var BarChart = /*#__PURE__*/function () {
  ...
  return _createClass(BarChart, [{
    key: "update",
    value: function update(data, dateTimeLabelFormats, tickInterval, text, label) {
      var config = {
        title: {
          text: label
        },
    ...
    key: "getDateRange",
    value: function getDateRange(range) {
      return {
        dateRange: _defineProperty({}, range === 'monthly' ? 'week' : 'day', '%d/%m/%y'),
    ...
    value: function updateFromJson(_ref) {
      var data = _ref.data,
        ...
        range = _ref.range,
        title = _ref.title;
      var _this$getDateRange = this.getDateRange(range),
        dateRange = _this$getDateRange.dateRange,
        tick = _this$getDateRange.tick;
      this.update(data, dateRange, tick, title, label);
    }
  }]);
}();
module.exports = BarChart;

},{"highcharts":147}],11:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function Modal($elm) {
    ...
    var modal = utils.closest(this.$elm, '.modal');
    if (modal) {
      modal.addEventListener('modalWindowClose', function () {
        _this.reset();
      });
    }
    this.$elm.addEventListener('click', function () {
      _this.copyToClipboard(_this.$elm.getAttribute('data-clipboard'), function () {
        _this.$elm.classList.add('button--success');
        _this.$elm.textContent = 'Copied!';
      }, function () {
        _this.$elm.classList.add('button--fail');
        _this.$elm.disabled = true;
        _this.$elm.textContent = 'Copy not supported';
      });
    });
  }
  return _createClass(Modal, [{
    key: "supportsClipboardAPI",
    value: function supportsClipboardAPI() {
      return navigator.clipboard ? true : false;
    }
  }, {
    key: "copyToClipboard",
    value: function copyToClipboard(text, onSuccess, onFail) {
    ...
    value: function copyToClipboardFallback(text) {
...
},{"../libs/elife-utils":49}],12:[function(require,module,exports){
'use strict';
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var Dismissible = require('./_Dismissible');
module.exports = /*#__PURE__*/function () {
  function CallToAction($elm) {
    var _this = this;
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    ...
    var $buttonWrapper = this.$elm.querySelector('.call-to-action__button_wrapper');
    $buttonWrapper.addEventListener('click', function () {
      return _this.dismissible.dismiss();
    });
    this.show();
  }
...
},{"./_Dismissible":48}],13:[function(require,module,exports){
'use strict';
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function CheckPMC($elm) {
    var _this = this;
    _classCallCheck(this, CheckPMC);
    this.$elm = $elm;
    var checkUrl = this.$elm.dataset.checkAvailable;
    var display = this.$elm.dataset.displayOnAvailable;
    this.checkPMC(checkUrl).then(function (pmc) {
      if (pmc) {
        _this.$elm.insertAdjacentHTML('beforebegin', display);
        _this.$elm.remove();
      } else {
        _this.$elm.parentNode.remove();
      }
    });
  }
  return _createClass(CheckPMC, [{
    key: "checkPMC",
    value: function checkPMC(url) {
      return utils.loadData(url).then(function (data) {
        return JSON.parse(data);
      }).then(function (pmc) {
        return 'pmcid' in pmc.records[0];
      });
    }
  }]);
}();

},{"../libs/elife-utils":49}],14:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function ContentAside($elm) {
    ...
    this.window.addEventListener('load', function () {
      utils.removeSeparatorFromLastOnLine(_this.$elm, '.contextual-data__item', 'no-separator');
    });
    this.window.addEventListener('resize', function () {
      utils.removeSeparatorFromLastOnLine(_this.$elm, '.contextual-data__item', 'no-separator');
    });
  }
  return _createClass(ContentAside, [{
    key: "prepareTimeline",
    value: function prepareTimeline(timeline) {
      var _this2 = this;
      if (timeline === null) {
        return;
      }
      var timelineParent = timeline.parentNode;
      var maxVisibleCollapsedElements = 1;

      // As each timeline entry has a dt and dd just count the dt element.
      var timelineCount = timeline.querySelectorAll('dt').length;
      var toggleTimelineVisibility = function toggleTimelineVisibility() {
        var hasActiveClass = timeline.querySelector('.definition-list--active') !== null;
        var dtElements = timeline.querySelectorAll('dt');
        var ddElements = timeline.querySelectorAll('dd');
        for (var i = 0; i < dtElements.length; i += 1) {
          if (hasActiveClass && !dtElements[i].classList.contains('definition-list--active') || !hasActiveClass && i !== 0) {
      ...
      var createToggle = function createToggle() {
        var existingLink = timelineParent.querySelector('a.toggle');
        if (!existingLink) {
          var link = utils.buildElement('a', ['toggle']);
          link.setAttribute('href', '#');
          timelineParent.appendChild(link);
          link.addEventListener('click', toggleContent.bind(_this2));
        }
      };
    ...
    key: "prepareScrollable",
    value: function prepareScrollable() {
      var _this3 = this;
      this.window.addEventListener('resize', function () {
    ...
    key: "isViewportWide",
    value: function isViewportWide() {
      return this.window.matchMedia('(min-width: 1000px)').matches;
    }
  }]);
}();

},{"../libs/elife-utils":49}],15:[function(require,module,exports){
"use strict";
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
module.exports = /*#__PURE__*/function () {
  function DelegateBehaviour($elm) {
    _classCallCheck(this, DelegateBehaviour);
    var behaviour = $elm.getAttribute('data-delegate-behaviour');
    var targets = $elm.querySelectorAll($elm.getAttribute('data-selector'));
    var classToApply = $elm.getAttribute('data-delegate-behaviour-class');
  ...
  return _createClass(DelegateBehaviour, null, [{
    key: "setInitialiseComponent",
    value: function setInitialiseComponent(initialiseComponent) {
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(FilterPanel, null, [{
    key: "setupEventListeners",
    value: function setupEventListeners(filters) {
    ...
    key: "findFilters",
    value: function findFilters($elm) {
...
module.exports = /*#__PURE__*/function () {
   ...
   */
  return _createClass(FragmentHandler, [{
    key: "getIdOfCollapsibleSection",
    value: function getIdOfCollapsibleSection(idToFind, doc) {
      var collapsibleSections = doc.querySelectorAll('.article-section--js');
      if (!collapsibleSections.length) {
        return null;
      }
      var $collapsibleSectionContainingFrag;
      [].forEach.call(collapsibleSections, function ($collapsibleSection) {
    ...
    value: function handleSectionOpeningViaHash(e) {
      ...
      var idOfCollapsibleSection = this.getIdOfCollapsibleSection(hash, this.doc);
...
},{"../libs/elife-utils":49}],18:[function(require,module,exports){
'use strict';
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function HiddenUntilChecked($elm) {
    var _this = this;
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, HiddenUntilChecked);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
    this.window = _window;
    this.doc = doc;
    var $checkboxId = $elm.getAttribute('data-checkbox-id');
    var $checkboxInput;
    if (!$checkboxId || !this.doc.getElementById($checkboxId)) {
      var $checkbox = this.buildCheckbox(this.$elm.querySelector('label').textContent, $checkboxId);
    ...
    $checkboxInput.addEventListener('change', function (e) {
      _this.toggleTextField(_this.$elm, $checkboxInput, e);
    });
    this.toggleTextField(this.$elm, $checkboxInput);
  }
  return _createClass(HiddenUntilChecked, [{
    key: "toggleTextField",
    value: function toggleTextField(elm, checkbox, event) {
      var text = elm.querySelector('input');
    ...
    key: "buildCheckbox",
    value: function buildCheckbox(labelText, id) {
      var $label = utils.buildElement('label', ['checkbox__item_label', 'hidden_until_checked__checkbox']);
      var $labelText = utils.buildElement('span', ['checkbox__item'], labelText, $label);
      var $checkbox = utils.buildElement('input', [], '', $label, $labelText);
...
},{"../libs/elife-utils":49}],19:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(Highlights, [{
    ...
    value: function checkTabPress(e) {
      ...
      if (e && e.keyCode === 9) {
        // Closest list item.
        var parentNode = utils.closest(document.activeElement, '.listing-list__item');

        // If we found that list item
        if (parentNode) {
          // The current slide is the nth list item (-1) taking into account the a tag at the top.
          this.setCurrentSlide(utils.getOrdinalAmongstSiblingElements(parentNode) - 1);
    ...
    key: "previousButton",
    value: function previousButton(e) {
      e.preventDefault();
    ...
    key: "onTabletOrMobile",
    value: function onTabletOrMobile() {
      return this.viewportNoWiderThan(this.desktopWidth);
    }
  }, {
    key: "switchBreakpoint",
    value: function switchBreakpoint() {
      if (this.onMobile()) {
        this.inView = 1;
      ...
      // Equalise heights.
      [].forEach.call(this.originalSlideWrappers, function (slideWrapper) {
    ...
    value: function renderCurrent() {
      this.render(this.$elm, this.$nextBtn, this.$prevBtn, this.currentSlide, this.carouselWidth, this.inView);
    }
  }, {
    key: "render",
    value: function render($el, $nextButton, $prevButton, thisSlide, carouselWidth, inView) {
      if (this.isFirstSlide()) {
      ...
      var numOfMargins = inView - 1;
      var totalMargins = numOfMargins * this.margin;

      // Slide width = Carousel width - margins / number in view
      var slideWidth = (carouselWidth - totalMargins) / inView;

      // Slide offset = Slide width plus margin
      var slideOffset = slideWidth + this.margin;

      // Negative offset of 'x' slide offsets
      var nudge = slideOffset * (thisSlide - 1) * -1;
...
},{"../libs/elife-utils":49}],20:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function HypothesisLoader($elm) {
    ...
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, HypothesisLoader);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
    ...
    this.$embedder.addEventListener('load', function () {
      _this.setUpAssetViewerFocus(_this.doc);
    });
    this.$embedder.addEventListener('error', function () {
      _this.handleLoadError(_this.$embedder);
    });
    this.doc.querySelector('head').appendChild(this.$embedder);
    this.$embedder.src = 'https://hypothes.is/embed.js';
  }
  return _createClass(HypothesisLoader, [{
    key: "setUpAssetViewerFocus",
    value: function setUpAssetViewerFocus(document) {
      document.addEventListener('scrolltorange', function (event) {
        if (!event.detail.startContainer) {
          return;
        }
        var $assetViewer = event.detail.startContainer.closest('.asset-viewer-inline');
        if ($assetViewer) {
    ...
    key: "handleLoadError",
    value: function handleLoadError($loader) {
    ...
    key: "assembleHypothesisConfig",
    value: function assembleHypothesisConfig(window) {
      var externalConfig = window.elifeConfig.hypothesis;
    ...
    key: "validateConfig",
    value: function validateConfig(externalConfig) {
      var services = externalConfig.services[0];
      ...
      if (services.onLoginRequest && services.onLogoutRequest || !(services.onLoginRequest || services.onLogoutRequest)) {
        throw new Error('Hypothesis config generation failed: couldn\'t find exactly one of the properties ' + '"onLoginRequest" and "onLogoutRequest"');
      }
      if (services.onLoginRequest && services.onProfileRequest) {
        throw new Error('Hypothesis config generation failed: found both mutually exclusive properties "onLoginRequest" ' + 'and "onProfileRequest"');
      }
      ...
      if (services.onLogoutRequest && services.onSignupRequest) {
        throw new Error('Hypothesis config generation failed: found both mutually exclusive properties "onLogoutRequest" ' + 'and "onSignupRequest"');
      }
    ...
    key: "validateAsUrl",
    value: function validateAsUrl(name, value) {
    ...
    key: "isProbablyUrl",
    value: function isProbablyUrl(candidate) {
      return typeof candidate === 'string' && candidate.match(/^https?:\/\/.*$/);
    }
  }, {
    key: "validateAsPopulatedString",
    value: function validateAsPopulatedString(name, value) {
      if (typeof value !== 'string' || !value.length) {
        HypothesisLoader.failValidationMissingProperty(name);
      }
    }
  }, {
    key: "failValidationMissingProperty",
    value: function failValidationMissingProperty(propertyName) {
      throw new Error("Hypothesis config generation failed: couldn't find a valid property with the name \"".concat(propertyName, "\""));
    }
  }]);
}();

},{"../libs/elife-utils":49}],21:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function HypothesisOpener($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, HypothesisOpener);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
    ...
    var visibleCountSelector = '[data-visible-annotation-count]';
  ...
  return _createClass(HypothesisOpener, [{
    key: "setupPreReadyIndicatorsWithTimer",
    value: function setupPreReadyIndicatorsWithTimer($loader) {
      var _this = this;
      ...
      var maxWaitTimer = this.window.setTimeout(this.handleTimerExpired.bind(this), maxWaitTime);
      $loader.addEventListener('loaderror', function (e) {
        _this.handleInitFail(maxWaitTimer, _this.window, e);
      });
      return maxWaitTimer;
    }
  }, {
    key: "handleInitFail",
    value: function handleInitFail(timer, win, err) {
      this.removeHypothesisUI();
      this.speechBubble.showFailureState(this.isWithinContextualData);
      var window = win || this.window;
    ...
    key: "handleTimerExpired",
    value: function handleTimerExpired() {
      this.handleInitFail(null, this.window, new Error('Hypothesis loading timed out'));
    }
  }, {
    key: "removeHypothesisUICounters",
    value: function removeHypothesisUICounters() {
      var counters = this.doc.querySelectorAll('[data-visible-annotation-count]');
      if (counters) {
        [].forEach.call(counters, function (counter) {
          var visuallyHiddenCounter = counter.parentNode.parentNode.querySelector('.visuallyhidden');
    ...
    key: "removeHypothesisUISidebar",
    value: function removeHypothesisUISidebar() {
      var sidebar = this.doc.querySelector('.annotator-frame');
      if (sidebar) {
        sidebar.parentElement.removeChild(sidebar);
      }
    }
  }, {
    key: "removeHypothesisUITriggers",
    value: function removeHypothesisUITriggers() {
      var triggers = this.doc.querySelectorAll('[data-hypothesis-trigger]');
      if (triggers) {
    ...
    key: "removeHypothesisUIPopupOnSelect",
    value: function removeHypothesisUIPopupOnSelect() {
      var _this2 = this;
      var obs;
      var remove$hypothesisAdder = function remove$hypothesisAdder(addedNode) {
        if (addedNode.nodeName === 'HYPOTHESIS-ADDER') {
          var adder = _this2.doc.querySelector('hypothesis-adder');
          if (adder && _typeof(adder.parentElement)) {
      ...
      var popup = this.doc.querySelector('hypothesis-adder');
      if (popup) {
        popup.parentElement.removeChild(popup);
      } else {
        obs = new MutationObserver(observerCallback);
        obs.observe(this.doc.querySelector('body'), {
          childList: true
        });
      }
    }
  }, {
    key: "removeHypothesisUI",
    value: function removeHypothesisUI() {
    ...
    key: "setupSpeechBubble",
    value: function setupSpeechBubble(isContextualData) {
      var speechBubble = new SpeechBubble(this.findElementWithClass('speech-bubble'));
      if (isContextualData) {
    ...
    key: "setupPlacementAndStyles",
    value: function setupPlacementAndStyles(isContextualData) {
    ...
    key: "findElementWithClass",
    value: function findElementWithClass(className) {
      if (this.$elm.querySelector(".".concat(className))) {
        return this.$elm.querySelector(".".concat(className));
      }
    ...
    key: "hookUpDataProvider",
    value: function hookUpDataProvider($elm, isWithinContextualData, visibleCountSelector, timer) {
      var _this3 = this;
      // Updated by the hypothesis client
      var $dataProvider = $elm.querySelector('[data-hypothesis-annotation-count]');
      if (!$dataProvider) {
      ...
      var observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
          try {
            ...
            _this3.updateVisibleCount(mutation.addedNodes[0].data, visibleCountSelector, isWithinContextualData);
            _this3.speechBubble.removeLoadingIndicator();
            _this3.window.clearTimeout(timer);
          } catch (error) {
            _this3.handleInitFail(timer, _this3.window, error);
          }
        });
      });
      observer.observe($dataProvider, {
        childList: true
      });
    }
  }, {
    key: "updateVisibleCount",
    value: function updateVisibleCount(value, selector, isContextualData) {
    ...
    key: "updateVisibleCountArticleBody",
    value: function updateVisibleCountArticleBody(count, selector) {
      if (count) {
    ...
    key: "setInitialDomLocation",
    value: function setInitialDomLocation($elm, articleType) {
      if (!articleType) {
        return;
      }
      try {
    ...
    key: "hasLoadAlreadyFailed",
    value: function hasLoadAlreadyFailed($loader) {
      return $loader.dataset.hypothesisEmbedLoadStatus === 'failed';
    }
  }, {
    key: "get$hypothesisLoader",
    value: function get$hypothesisLoader($ancestor) {
      var $loader = $ancestor.querySelector('#hypothesisEmbedder');
      if ($loader) {
        return $loader;
      }
    ...
    key: "applyStyleInitial",
    value: function applyStyleInitial($elm) {
      $elm.classList.add('hypothesis-opener');
      $elm.style.display = 'inline-block';
      $elm.style.cursor = 'pointer';
    }
  }, {
    key: "applyStyleArticleBody",
    value: function applyStyleArticleBody($elm) {
      $elm.style.display = 'block';
      $elm.style.float = 'right';
      $elm.style.marginBottom = '48px';
    }
  }, {
    key: "positionCentrallyInline",
    value: function positionCentrallyInline($elm, $contentContainer) {
      var $target = HypothesisOpener.findTarget($contentContainer);
      if (!$target) {
    ...
    key: "positionBySecondSection",
    value: function positionBySecondSection($elm, $contentContainer) {
      var $firstSection = $contentContainer.querySelectorAll('.article-section--first');
      if ($firstSection.length) {
        $firstSection[$firstSection.length - 1].nextElementSibling.querySelector('.article-section__body').appendChild($elm);
        HypothesisOpener.wrappedInContainer($elm);
        return;
      }
      throw new Error('Trying to position hypothesis opener in second section, but ' + 'can\'t find element with the css class article-section--first.');
    }
  }, {
    key: "positionByFirstSection",
    value: function positionByFirstSection($elm, $contentContainer) {
      var $firstSection = $contentContainer.querySelectorAll('.article-section--first');
      if ($firstSection.length) {
        if ($firstSection[$firstSection.length - 1].classList.contains('article-section--highlighted')) {
          $firstSection[$firstSection.length - 1].parentNode.insertBefore($elm, $firstSection[$firstSection.length - 1].nextElementSibling);
        } else {
      ...
      throw new Error('Trying to position hypothesis opener by first section but can\'t find element' + ' with the css class article-section--first.');
    }
  }, {
    key: "wrappedInContainer",
    value: function wrappedInContainer($elm) {
    ...
    key: "positionEnd",
    value: function positionEnd($elm, $contentContainer) {
      $contentContainer.appendChild($elm);
      HypothesisOpener.wrappedInContainer($elm);
    }
  }, {
    key: "findPositioningMethod",
    value: function findPositioningMethod(articleType) {
      var positioners = {
    ...
    key: "findTarget",
    value: function findTarget($contentContainer) {
      var target = null;
      var centre = Math.floor(($contentContainer.querySelectorAll('p').length - 1) / 2);
      [].forEach.call($contentContainer.querySelectorAll('p'), function (possible, index) {
        if (target === null && index >= centre && !HypothesisOpener.targetWithinInLineProfile(possible) && !HypothesisOpener.targetWithinBlockquote(possible) && !HypothesisOpener.targetBelowSectionHeading(possible)) {
          target = possible;
        }
      });
      return target;
    ...
    key: "targetWithinInLineProfile",
    value: function targetWithinInLineProfile($target) {
      return $target.parentNode.parentNode.classList.contains('inline-profile');
    }
  }, {
    key: "targetWithinBlockquote",
    value: function targetWithinBlockquote($target) {
      return $target.parentNode.nodeName === 'BLOCKQUOTE';
    }
  }, {
    key: "targetBelowSectionHeading",
    value: function targetBelowSectionHeading($target) {
      return utils.getOrdinalAmongstSiblingElements($target) === 1 && $target.parentNode.parentNode.classList.contains('article-section');
    }
  }]);
}();

},{"../libs/elife-utils":49,"./SpeechBubble":41}],22:[function(require,module,exports){
'use strict';
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
module.exports = /*#__PURE__*/function () {
  function HypothesisTrigger($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, HypothesisTrigger);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
  ...
  //  - the loaderror event fires before Hypothesis is ready
  //  - the maxWaitTimer expires
  return _createClass(HypothesisTrigger, [{
    key: "setupPreReadyIndicatorsWithTimer",
    value: function setupPreReadyIndicatorsWithTimer($loader) {
      var _this = this;
    ...
    key: "hookUpDataProvider",
    value: function hookUpDataProvider($elm, visibleCountSelector, timer) {
      var _this3 = this;
      // Updated by the hypothesis client
      var $dataProvider = $elm.querySelector('[data-hypothesis-annotation-count]');
      if (!$dataProvider) {
      ...
      var observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
          try {
            ...
            _this3.updateVisibleCount(mutation.addedNodes[0].data, visibleCountSelector);
            _this3.window.clearTimeout(timer);
          } catch (error) {
            _this3.handleInitFail(timer, _this3.window, error);
          }
    ...
    key: "updateVisibleCount",
    value: function updateVisibleCount(value, selector) {
      var count = parseInt(value);
      if (isNaN(count) || count < 0) {
        return;
      }
    ...
    key: "updateVisibleCountArticleBody",
    value: function updateVisibleCountArticleBody(count, selector) {
      var target = this.$elm.querySelector(selector);
      if (count) {
...
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var Dismissible = require('./_Dismissible');
module.exports = /*#__PURE__*/_createClass(function InfoBar($elm) {
  var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
  var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
...
},{"./_Dismissible":48}],24:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function JumpMenu($elm) {
    ...
    if (this.links.length > 0) {
      ...
      var scrollingHandler = utils.throttle(function () {
      ...
      this.window.addEventListener('resize', utils.throttle(function () {
        _this.handleResize(scrollingHandler, _this.handleScrolling);
      }, 200));
    }
  }
  return _createClass(JumpMenu, [{
    key: "isViewportWideEnoughForJumpMenu",
    value: function isViewportWideEnoughForJumpMenu() {
      return this.window.matchMedia('(min-width: 1200px)').matches;
    }
  }, {
    key: "handleResize",
    value: function handleResize(scrollingHandler, scrollingHandlerImmediate) {
      var isViewportWideEnoughForJumpMenu = this.isViewportWideEnoughForJumpMenu();
    ...
    key: "startHandlingScrolling",
    value: function startHandlingScrolling(scrollingHandler, scrollingHandlerImmediate) {
      this.window.addEventListener('scroll', scrollingHandler);
      this.isScrollingHandled = true;
      scrollingHandlerImmediate.call(this);
    }
  }, {
    key: "stopHandlingScrolling",
    value: function stopHandlingScrolling(scrollingHandler) {
    ...
    value: function handleHighlighting(findClosest) {
      var $firstViewableHeading = this.findFirstInView(this.collapsibleSectionHeadings, this.doc, this.window);
      var firstLogicalHeadingText = this.collapsibleSectionHeadings[0] ? this.collapsibleSectionHeadings[0].innerHTML : '';
      var $section = JumpMenu.findSectionForLinkHighlight($firstViewableHeading, firstLogicalHeadingText, findClosest, this.doc);
      if ($section && typeof $section.id === 'string') {
        var $target = JumpMenu.findLinkToHighlight(this.linksList, "[href=\"#".concat($section.id, "\"]"));
        if ($target) {
     ...
     */
    function findFirstInView(elementList, doc, win) {
      // Ensure elements is an array
      var elements = [].slice.call(elementList);
      var $found = null;
    ...
    key: "getAllCollapsibleSectionHeadings",
    value: function getAllCollapsibleSectionHeadings(doc) {
      return doc.querySelectorAll('[data-behaviour="ArticleSection"] > .article-section__header .article-section__header_text');
    }
  }, {
    key: "updateHighlighting",
    value: function updateHighlighting($target, linksList) {
      JumpMenu.clearJumpMenuHighlight(linksList);
      JumpMenu.highlightJumpMenu($target);
    }
  }, {
    key: "findSectionForLinkHighlight",
    value: function findSectionForLinkHighlight($heading, firstHeadingText, findClosest, doc) {
      if (!$heading) {
        return;
      }
      var navigationHeight = 74;
      var tabbedNavigation = doc.querySelector('.tabbed-navigation');
    ...
    key: "clearJumpMenuHighlight",
    value: function clearJumpMenuHighlight(linksList) {
      var links = [].slice.call(linksList);
      links.forEach(function ($link) {
        $link.classList.remove('jump-menu__active');
      });
    }
  }, {
    key: "findLinkToHighlight",
    value: function findLinkToHighlight($linksList, selector) {
      return $linksList.querySelector(selector);
    }
  }, {
    key: "highlightJumpMenu",
    value: function highlightJumpMenu($jumpMenu) {
      $jumpMenu.classList.add('jump-menu__active');
    }
  }]);
}();

},{"../libs/elife-utils":49}],25:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function LoginControl($elm) {
    ...
    try {
      var linkFieldRoots = this.$elm.dataset.linkFieldRoots;
      var dataAttributeRoots;
      if (linkFieldRoots) {
        dataAttributeRoots = LoginControl.deriveDataAttributeRoots(this.$elm.dataset.linkFieldRoots, this.$elm);
      }
   ...
   *
   */
  return _createClass(LoginControl, [{
    key: "setPropertiesFromDataAttributes",
    value:
    /**
     ...
     */
    function setPropertiesFromDataAttributes(dataAttributeRoots, $elm) {
     ...
     */
    function buildControl(extraLinksToBuild, $elm, buildElement) {
      var $nav = buildElement.call(null, 'nav');
    ...
    key: "insertToggle",
    value: function insertToggle($container, $elm, buildElement) {
      var $toggle = buildElement.call(null, 'a', ['login-control__controls_toggle'], '', $container);
      $toggle.setAttribute('href', this.defaultUri);
      var iconAsString = $elm.dataset.icon;
    ...
    key: "buildMenu",
    value: function buildMenu(extraLinksToBuild, $elm, buildElement) {
      var $list = buildElement.call(null, 'ul', ['login-control__controls', 'hidden']);
    ...
    key: "insertDefaultLink",
    value: function insertDefaultLink($container, $elm, buildElement) {
      var $li = buildElement.call(null, 'li', ['login-control__control'], '', $container);
      var $a = buildElement.call(null, 'a', ['login-control__link'], '', $li);
      $a.setAttribute('href', this.defaultUri);
      buildElement.call(null, 'div', ['login-control__display_name'], this.displayName, $a);
      var subsidiaryText = $elm.dataset.subsidiaryText;
      if (subsidiaryText) {
    ...
    key: "insertExtraLinks",
    value: function insertExtraLinks(extraLinksData, $container, buildElement) {
      if (!Array.isArray(extraLinksData) || !extraLinksData.length) {
        throw new Error('Unable to build extra links, no data supplied');
      }
      extraLinksData.forEach(function (extraLinkData) {
    ...
    key: "deriveDataAttributeRoots",
    value: function deriveDataAttributeRoots(rootsList, $elm) {
      if (!LoginControl.validateDataAttributeRootsList(rootsList)) {
        throw new SyntaxError('invalid roots list supplied');
      }
      var dataAttributeRoots = rootsList.split(',').map(function (root) {
        return root.trim();
      });
    ...
    key: "areAllImpliedDataAttributesPresent",
    value: function areAllImpliedDataAttributesPresent(dataAttributeRoots, $elm) {
      var areAllPresent = true;
      dataAttributeRoots.forEach(function (root) {
        if (!$elm.dataset[LoginControl.convertKebabCaseToCamelCase("".concat(root, "-uri"))] || !$elm.dataset[LoginControl.convertKebabCaseToCamelCase("".concat(root, "-text"))]) {
          areAllPresent = false;
        }
      });
    ...
    key: "validateDataAttributeRootsList",
    value: function validateDataAttributeRootsList(rootsList) {
      return typeof rootsList === 'string' && rootsList.search(/^[ \t]*[a-z][a-z-$_]*[^-,][ \t]*(,[ \t]*[a-z][a-z-$_]*[^-,][ \t]*)*$/) > -1;
    }
  }, {
    key: "deriveLinksToBuild",
    value: function deriveLinksToBuild(dataAttributeRoots, $elm) {
      var linksToBuild = [];
      dataAttributeRoots.forEach(function (dataAttributeRoot) {
        var textDataAttribute = "".concat(dataAttributeRoot, "-text");
        var textProperty = LoginControl.convertKebabCaseToCamelCase(textDataAttribute);
        var text = $elm.dataset[textProperty];
        var uriDataAttribute = "".concat(dataAttributeRoot, "-uri");
        var uriProperty = LoginControl.convertKebabCaseToCamelCase(uriDataAttribute);
        var uri = $elm.dataset[uriProperty];
        if (text && uri) {
          linksToBuild.push({
            text: text,
            uri: uri
    ...
    key: "convertKebabCaseToCamelCase",
    value: function convertKebabCaseToCamelCase() {
      var kebabCase = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      if (!kebabCase || typeof kebabCase !== 'string') {
        return null;
      }

      // eslint-disable-next-line no-useless-escape
      return kebabCase.replace(/\-([a-z])/g, function (x) {
        return x.substring(1).toUpperCase();
      });
    }
  }, {
    key: "insertLink",
    value: function insertLink(linkData, $container, buildElement) {
      var $li = buildElement.call(null, 'li', ['login-control__control'], '', $container);
      var $a = buildElement.call(null, 'a', ['login-control__link'], linkData.text, $li);
      $a.setAttribute('href', linkData.uri);
    }
  }]);
}();

},{"../libs/elife-utils":49}],26:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(MainMenu, [{
    ...
    value: function moveWithinDom() {
      ...
      var $siteHeaderWrapper = this.doc.querySelector('.wrapper--site-header');
    ...
    key: "buildCloseControl",
    value: function buildCloseControl() {
      var $close;
      if (!this.$elm.querySelector('#mainMenuCloseControl')) {
        var $parent = this.$elm.querySelector('.main-menu__title-container');
        $close = utils.buildElement('button', ['main-menu__close_control'], 'Close', $parent, $parent.firstElementChild);
...
},{"../libs/elife-utils":49,"./Overlay":32}],27:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(Math, null, [{
    ...
    value: function flattenSingleRowMtable(doc) {
      doc.querySelectorAll('math').forEach(function (math) {
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(MediaChapterListingItem, [{
    key: "listenForChapterChange",
    value: function listenForChapterChange(e) {
      var $player = this.document.getElementById(e.detail);
      if (!!$player) {
    ...
    value: function createLink(document, $rootElm, startTime) {
      var $title = $rootElm.querySelector('.media-chapter-listing-item__header_text');
      if (!$title) {
        return;
      }
      var titleText;
...
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/_createClass(function Meta($elm) {
  var _this = this;
  var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
  var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
  ...
  this.doc = doc;
  this.window.addEventListener('load', function () {
    utils.removeSeparatorFromLastOnLine(_this.$elm, '.meta > *', 'no-separator');
  });
  this.window.addEventListener('resize', function () {
    utils.removeSeparatorFromLastOnLine(_this.$elm, '.meta > *', 'no-separator');
  });
...
},{"../libs/elife-utils":49}],30:[function(require,module,exports){
'use strict';
...
var Metrics = /*#__PURE__*/function () {
  function Metrics($el) {
    ...
    this.$el = $el;
    var $charts = utils.buildElement('div', ['charts'], '', this.$el);
    var container = utils.buildElement('div', [], 'Loading...', $charts);
    container.id = this.$el.dataset.containerId;
    var p = utils.buildElement('p', [], '', $charts);
    ...
    var $grouping = utils.buildElement('ol', ['button-collection', 'button-collection--centered', 'button-collection--compact'], '', this.$el);
    ...
    var parent = utils.closest(this.$el, '.article-section');
    if (parent) {
      parent.addEventListener('expandsection', function () {
        // This catches cases where the data may be loading, which breaks.
        if (_this.getSelectedMetric().page !== 0) {
          _this.renderView($el, _this.getSelectedMetric());
        }
      });
    }
    ...
    var availableMetrics = utils.flatten(this.availableCharts.map(function (chart) {
      return _this.availablePeriods.map(function (period) {
        return "".concat(chart, "-by-").concat(period);
      });
    }));
    this.loadMore = this.loadMore.bind(this);
    this.barChart = new BarChart($el.dataset.containerId);
    this.metrics = availableMetrics.map(function (metric) {
      return {
        name: metric,
        page: 0,
        viewPage: 1,
  ...
  return _createClass(Metrics, [{
    key: "trigger",
    value: function trigger(temporalDirection, side, p) {
      var a = utils.buildElement('a', ['trigger', 'trigger--' + temporalDirection], this.chevron(side), p);
      a.href = '#';
      return a;
    }
  }, {
    key: "chevron",
    value: function chevron(side) {
      var svg = 'chevron' + side + 'Svg';
      var srcset = 'chevron' + side + 'Srcset';
      var src = 'chevron' + side + 'Src';
      return '<picture>' + '<source srcset="' + this.$el.dataset[svg] + '" type="image/svg+xml">' + '<img srcset="' + this.$el.dataset[srcset] + '" src="' + this.$el.dataset[src] + '" alt="Navigate ' + side.toLowerCase() + ' icon">' + '</picture>';
    }
  }, {
    key: "groupingButton",
    value: function groupingButton($grouping, label) {
      var $item = utils.buildElement('li', ['button-collection__item'], null, $grouping);
      var button = utils.buildElement('a', ['button', 'button--outline', 'button--small'], label, $item);
      button.href = '#';
      return button;
    }
  }, {
    ...
    value: function changePeriod(period) {
      ...
      return function (e) {
        ...
        // Change button style.
        var $current = _this2.$el.querySelector('.button--default');
        ...
        _this2.log("changed period to ".concat(period));

        // Change metric and reload.
        return _this2.changeMetric(_this2.selected, period).then(function () {
          _this2.renderView(_this2.$el, _this2.getSelectedMetric());
        });
      };
    }
  }, {
    ...
    value: function nextButton(e) {
      ...
      this.loadMore().then(function () {
        _this3.$el.classList.remove('charts--loading');
        _this3.updateSelectedMetric(function (m) {
          return Object.assign(m, {
            viewPage: m.viewPage + 1
          });
        });
        _this3.renderView(_this3.$el, _this3.getSelectedMetric());
      });
    }
  }, {
    key: "prevButton",
    value: function prevButton(e) {
      e.preventDefault();
      this.updateSelectedMetric(function (m) {
        return Object.assign(m, {
          viewPage: m.viewPage - 1
    ...
    value: function nextChart() {
      ...
      this.changeMetric(this.availableCharts[this.currentChart], this.period).then(function () {
        _this4.renderView(_this4.$el, _this4.getSelectedMetric());
      });
    }
  }, {
    key: "previousChart",
    value: function previousChart() {
      var _this5 = this;
      if (this.isFirstPage()) {
        return null;
      }
      this.currentChart = this.currentChart - 1;
      this.changeMetric(this.availableCharts[this.currentChart], this.period).then(function () {
        _this5.renderView(_this5.$el, _this5.getSelectedMetric());
      });
    }
  }, {
    key: "changeMetric",
    value: function changeMetric(metric, period) {
      var _this6 = this;
      this.$el.classList.add('charts--loading');
      if (this.isLocked) {
        this.log('Finishing in progress requests first');
        return this.lock.then(function () {
          return _this6.changeMetric(metric, period);
        });
      }
    ...
    key: "getSelectedName",
    value: function getSelectedName() {
      this.log('selected name: ', "".concat(this.selected, "-by-").concat(this.period));
      return "".concat(this.selected, "-by-").concat(this.period);
    }
  }, {
    key: "getEndpoint",
    value: function getEndpoint(url, type, id, metric, by, perPage, page) {
      return "".concat(url, "/metrics/").concat(type, "/").concat(id, "/").concat(metric, "?by=").concat(by, "&per-page=").concat(perPage, "&page=").concat(page);
    }
  }, {
    key: "getSelectedMetric",
    value: function getSelectedMetric() {
    ...
    key: "getNthPage",
    value: function getNthPage(n, firstMonth, firstMonthYear, direction) {
      var month = firstMonth;
      var year = firstMonthYear;
    ...
    key: "getJsonPage",
    value: function getJsonPage(page, perView) {
      return utils.loadData(this.getEndpoint(this.endpoint, this.type, this.id, this.selected, this.period, perView, page));
    }
  }, {
    key: "updateSelectedMetric",
    value: function updateSelectedMetric(fn) {
      var _this7 = this;
      this.metrics = this.metrics.map(function (m) {
        return m.name === _this7.getSelectedName() ? fn(m) : m;
      });
    }
  }, {
    key: "saveResults",
    value: function saveResults(data, page, remaining) {
    ...
    key: "periodToTimestamp",
    value: function periodToTimestamp(entry) {
      return Date.UTC(parseInt(entry.year, 10), parseInt(entry.month - 1, 10), parseInt(entry.day ? entry.day : 1, 10));
    }
  }, {
    key: "transformPeriods",
    value: function transformPeriods(periods) {
      this.log(periods);

      // Converts 2015-11-01 to { year: 2015, month: 11, day: 1 }
      return periods.map(function (_ref) {
    ...
    key: "filterPeriod",
    value: function filterPeriod(month, year) {
      return function (d) {
        return parseInt(d.month, 10) === month && parseInt(d.year, 10) === year;
      };
    }
  }, {
    key: "filterYearPeriod",
    value: function filterYearPeriod(year) {
      return function (d) {
        return parseInt(d.year, 10) === year;
      };
    }
  }, {
    key: "filterMonthPeriod",
    value: function filterMonthPeriod(firstMonth, firstMonthYear, viewPage) {
      return function (d) {
        if (parseInt(d.month, 10) >= firstMonth && parseInt(d.year, 10) === firstMonthYear + (viewPage - 1)) {
          return true;
        }
        return parseInt(d.month, 10) <= firstMonth && parseInt(d.year, 10) === firstMonthYear + viewPage;
      };
    }
  }, {
    key: "renderView",
    value: function renderView($el, data) {
      var _this8 = this;
      var periods;
      var hasNextPage;
      var _data$firstMonth = _slicedToArray(data.firstMonth, 2),
        firstMonth = _data$firstMonth[0],
        firstMonthYear = _data$firstMonth[1];
      var current = this.getNthPage(data.viewPage, firstMonth, firstMonthYear, data.reverse);
      var next = this.getNthPage(data.viewPage + 1, firstMonth, firstMonthYear, data.reverse);

      // Current page of results.
      var currentFilter = this.period === 'day' ? this.filterPeriod(current.month, current.year) : this.filterYearPeriod(firstMonthYear + (data.viewPage - 1) * data.reverse);

      // Next page of results.
      var nextFilter = this.period === 'day' ? this.filterPeriod(next.month, next.year) : this.filterYearPeriod(firstMonthYear + data.viewPage * data.reverse);
      ...
      this.barChart.updateFromJson({
        data: {
          ...
          periods: periods.map(function (entry) {
            return [_this8.periodToTimestamp(entry), entry.value];
          })
        },
    ...
    value: function loadMore() {
      var _this9 = this;
      var currentMetric = this.getSelectedMetric();
      ...
      var page = currentMetric.page + 1;

      // Over fetch so we know that there is a next month to load.
      var perView = this.period === 'day' ? 32 : 13;

      // The next XHR
      this.currentRrequest = this.getJsonPage(page, perView);
      return this.currentRrequest.then(function (j) {
        return JSON.parse(j);
      }).then(function (json) {
        _this9.total = json.totalPeriods || 0;
        _this9.log('parse page ', page);
        var remaining = _this9.total - perView * page;
        var remainingPages = Math.ceil(remaining / perView);
        _this9.saveResults(json, page, remainingPages);
        _this9.isLocked = false;
        deferred.resolve();
        _this9.log('resolved,', 'total', _this9.total, 'remaining requests:', remainingPages);
        return json;
      });
    }
  }]);
...
},{"../libs/elife-utils":49,"./BarChart":10}],31:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  function Modal($elm) {
    ...
    this.window = _window;
    this.doc = doc;
    var $triggerId = this.$elm.getAttribute('data-trigger-id');
    var $trigger;
    ...
    $trigger.addEventListener('click', function (event) {
      return _this.modalToggle(event);
    });
    this.$elm.querySelector('.modal-content__button').addEventListener('click', function (event) {
      return _this.modalToggle(event);
    });
    this.window.addEventListener('click', function (event) {
      return _this.windowOnClick(event);
    });
    this.window.addEventListener('resize', function () {
      if (_this.$elm.classList.contains('small-device') && _this.window.innerWidth >= 480) {
        _this.modalWindow.classList.remove('modal-content__show');
      }
    });
  ...
  return _createClass(Modal, [{
    key: "modalToggle",
    value: function modalToggle(event) {
    ...
    key: "windowOnClick",
    value: function windowOnClick(event) {
...
},{"../libs/elife-utils":49}],32:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
   ...
   * @param doc document
   */
  function Overlay($parent, $followingSibling, id, z) {
    ...
    value: function assignTop(top) {
      if (!isNaN(top)) {
        if (!this.$elm.style) {
          ...
          this.$elm.style.top = "".concat(top, "px");
        }
      }
    }
  }, {
    key: "find$parent",
    value: function find$parent(parentCandidate) {
...
},{"../libs/elife-utils":49}],33:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(Pager, [{
    key: "createDocFragFromString",
    value: function createDocFragFromString(str) {
    ...
    value: function redirectToFullResultsPage() {
      var loaderLink = this.getLoaderLink();
      if (loaderLink) {
    ...
    key: "setLoaderLinkFromData",
    value: function setLoaderLinkFromData(normalisedData) {
      var regex = /.*(<div[^>]*class="[^"]*pager[^"]*"[^>]*>.*<\/div>).*/;
      var $docFragOfPagerFoundInData = this.createDocFragFromString(normalisedData.match(regex)[1]);
      if (!$docFragOfPagerFoundInData) {
        this.loaderLink = '#';
        return;
      }
      var nextPageButton = $docFragOfPagerFoundInData.querySelector('.button:nth-child(2)');
      if (!nextPageButton) {
        this.loaderLink = '#';
        return;
      }
      var nextPageButtonLink = nextPageButton.href;
    ...
    key: "updatePager",
    value: function updatePager(normalisedData) {
    ...
    key: "updateUrl",
    value: function updateUrl(loaderLink) {
      if (loaderLink) {
    ...
    value: function handleLoad(data) {
      var loaderLink = this.loaderLink;
      var normalisedData;
      try {
    ...
    value: function handleLoadRequest(e) {
      ...
      this.loadData(this.getLoaderLink(), this.window.XMLHttpRequest).then(this.handleLoad.bind(this), this.handleError.bind(this));
      this.setLoadingState();
    }
  }, {
    key: "loadData",
    value: function loadData(url, XMLHttpRequest) {
...
},{"../libs/elife-utils":49}],34:[function(require,module,exports){
'use strict';
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
module.exports = /*#__PURE__*/function () {
  function PersonalisedCoverDownload($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, PersonalisedCoverDownload);
    if (!$elm) {
      return;
    }
    this.$elm = $elm;
  ...
  return _createClass(PersonalisedCoverDownload, [{
    key: "init",
    value: function init() {
      this.prepareButtons();
    ...
    value: function prepareButtons() {
      var _this = this;
      var headings = this.$elm.querySelectorAll('.list-heading');
      [].forEach.call(headings, function (heading) {
        var group = heading.innerText;
        var buttonCollectionClass = 'button-collection--' + group.toLowerCase().replace(/\s+/g, '');
        heading.classList.add('visuallyhidden');
        heading.nextElementSibling.classList.add(buttonCollectionClass);
        _this.groups[buttonCollectionClass] = group;
      });
    }
  }, {
    key: "introduceCheckbox",
    value: function introduceCheckbox() {
      var _this2 = this;
      if (Object.keys(this.groups).length === 2) {
        this.toggleButtons();
        var checkbox = this.createCheckbox();
        checkbox.addEventListener('change', function (event) {
          _this2.toggleButtons(event.target.checked);
        });
      }
    }
  }, {
    ...
    value: function createCheckbox() {
      var label1 = this.groups[Object.keys(this.groups)[0]];
      var label2 = this.groups[Object.keys(this.groups)[1]];
      var $formItemCheckbox = this.doc.createElement('div');
      $formItemCheckbox.setAttribute('class', 'form-item form-item__checkbox');
      $formItemCheckbox.innerHTML = "\n    <div for=\"letter-style\" class=\"checkbox__label selected-model\" aria-label=\"".concat(label1, "\">").concat(label1, "</div>\n\n    <label class=\"form-item__label toggle-checkbox\">\n      <input type=\"checkbox\" id=\"letter-style\" class=\"type-of-model\">\n      <span class=\"toggle-checkbox__slider round\"></span>\n    </label>\n\n    <div for=\"letter-style\" class=\"checkbox__label\" aria-label=\"").concat(label2, "\">").concat(label2, "</div>\n    ");
...
module.exports = /*#__PURE__*/function () {
  function Popup($elm) {
    ...
    this.$link.addEventListener('click', function (e) {
      return _this.handleLinkClick(e);
    });
  ...
  return _createClass(Popup, [{
    ...
    value: function handleLinkClick(e) {
      ...
      if (!this.window.matchMedia("(min-width: ".concat(this.thresholdWidth, "px)")).matches) {
      ...
      this.render(e).then(function () {
        if (_this2.isEmpty) {
          var link = _this2.$link;
          _this2.$link = null;
          link.click();
        }
      });
    ...
    value: function handleDocumentClick(e) {
      ...
      var closestPopup = utils.closest(e.target, '.popup');
    ...
    key: "getResolver",
    value: function getResolver(link) {
      if (this.resolver) {
    ...
    key: "getBodyContentsFromNode",
    value: function getBodyContentsFromNode(node) {
      if (!node) {
      ...
      var target = node.getElementById(node.getAttribute('data-popup-contents'));
      if (!target) {
        // Also mark empty.
        return this.emptyResponse();
      }
    ...
    key: "emptyResponse",
    value: function emptyResponse() {
      this.isEmpty = true;
      return null;
    }
  }, {
    key: "requestContents",
    value: function requestContents(e) {
      var _this3 = this;
      ...
      return this.getResolver(this.$link).then(function (r) {
        // If there is contents the come back we add it to our object.
        if (r) {
          _this3.bodyContents = _this3.getBodyContentsFromNode(r.querySelector(_this3.$link.hash));
          return _this3.render(e);

          // If not, we set this and ignore.
        } else {
          _this3.emptyResponse();
        }
        return Promise.resolve(_this3.$link);
      });
    }
  }, {
    key: "createBottomBar",
    value: function createBottomBar(label, link) {
      var $bottomBar = utils.buildElement('div', ['popup__actions', 'clearfix']);
      var $seeInReferences = utils.buildElement('a', ['popup__button', 'popup__button--right'], label, $bottomBar);
      $seeInReferences.href = link;
      return $bottomBar;
    }
  }, {
    key: "createPopupBox",
    value: function createPopupBox() {
      // Get the content
      var $content;
      ...
      if ($content instanceof HTMLElement) {
        var $ancillary = utils.buildElement('div', ['popup__content__ancillary']);
        var exclusions = ['reference__title', 'reference__authors_list', 'reference__authors_list_suffix', 'author-details__name', 'about-profile__name', 'about-profile__role'];
        var ancillaries = [];
        ...
        [].forEach.call($content.children, function ($contentChild) {
          var isAncillary = false;
          [].forEach.call($contentChild.classList, function (cssClass) {
        ...
        ancillaries.forEach(function ($ancillaryChild) {
    ...
    key: "createPopupHitBox",
    value: function createPopupHitBox() {
    ...
    key: "calcInitialPosition",
    value: function calcInitialPosition(e, width) {
    ...
    key: "setAccessibilityAttributesPopupHitBox",
    value: function setAccessibilityAttributesPopupHitBox(isToBeShown) {
      if (isToBeShown) {
    ...
    key: "setAttributesForOpenPopupHitBox",
    value: function setAttributesForOpenPopupHitBox(e) {
      this.setAccessibilityAttributesPopupHitBox(true, e);
    }
  }, {
    key: "setAttributesForClosedPopupHitBox",
    value: function setAttributesForClosedPopupHitBox() {
      this.setAccessibilityAttributesPopupHitBox(false);
    }
  }, {
    key: "positionPopupHitBox",
    value: function positionPopupHitBox(e) {
      this.popupHitBox.style.display = '';
      var width = this.popupHitBox.offsetWidth;
      var height = this.popupHitBox.offsetHeight;
      var initialPosition = this.calcInitialPosition(e, width);
      var left = initialPosition.left;
      var top = initialPosition.top;
      ...
      var topIfAbove = e.pageY - height - 20;
      ...
      this.popupHitBox.style.left = "".concat(left, "px");
      this.popupHitBox.style.top = "".concat(top, "px");
    ...
    value: function render(e) {
      ...
      if (!this.popupHitBox) {
        ...
        var children = [this.bodyContents];
        if (this.label) {
          children.push(this.createBottomBar(this.label, this.$link.href));
        }

        // Create elements.
        this.popupHitBox = this.createPopupHitBox(this.createPopupBox.apply(this, children));
        ...
        this.window.addEventListener('resize', utils.debounce(function () {
          // If the viewport is too narrow, we don't.
          if (!_this4.window.matchMedia("(min-width: ".concat(_this4.thresholdWidth, "px)")).matches) {
            return;
          }
          _this4.isOpen = false;
          _this4.render(e);
      ...
      if (this.isOpen) {
        ...
        this.popupHitBox.addEventListener('blur', function () {
          _this4.setAttributesForClosedPopupHitBox();
          _this4.isOpen = false;
          _this4.$link.focus();
        });
      } else {
    ...
    key: "setLinksClasses",
    value: function setLinksClasses($root) {
      if ($root instanceof HTMLElement) {
        [].slice.call($root.querySelectorAll('a')).forEach(function ($link) {
...
},{"../libs/elife-utils":49}],36:[function(require,module,exports){
'use strict';
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function SectionListingLink($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, SectionListingLink);
    try {
  ...
  return _createClass(SectionListingLink, [{
    key: "init",
    value: function init() {
      var _this = this;
    ...
    key: "updateView",
    value: function updateView($list, $defaultListParent, $wideViewListParent, thresholdWidthInEm) {
      if (this.window.matchMedia("(min-width: ".concat(thresholdWidthInEm, "em)")).matches) {
    ...
    key: "showWideView",
    value: function showWideView($list, $wideViewListParent) {
    ...
    key: "restoreDefaultView",
    value: function restoreDefaultView($list, $defaultListParent) {
...
},{"../libs/elife-utils":49}],38:[function(require,module,exports){
'use strict';
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function SideBySideView($elm, src, $header) {
    var _this = this;
    ...
    _classCallCheck(this, SideBySideView);
    if (!$elm) {
      return;
    }
    this.window = _window;
    ...
    this.$global = $elm;
    this.$header = $header;
    this.eachButHeader = function (callback) {
      [].forEach.call(_this.$global.childNodes, function (node) {
        // skip text nodes
        if (!node.tagName) {
          return;
        }
        if (utils.areElementsNested(node, _this.$header)) {
          return;
        }
        callback(node);
      });
  ...
  return _createClass(SideBySideView, [{
    key: "open",
    value: function open() {
    ...
    key: "saveScrollingPosition",
    value: function saveScrollingPosition() {
      this.currentYScrollPos = this.window.pageYOffset;
      this.window.scroll(0, 0);
    }
  }, {
    key: "restoreScrollingPosition",
    value: function restoreScrollingPosition() {
      this.window.scroll(0, this.currentYScrollPos);
      this.currentYScrollPos = null;
    }
  }, {
    key: "hideEverythingButHeader",
    value: function hideEverythingButHeader() {
      this.eachButHeader(function (element) {
        element.classList.add('hidden');
      });
    }
  }, {
    key: "showEverything",
    value: function showEverything() {
      this.eachButHeader(function (element) {
    ...
    key: "createCloseBar",
    value: function createCloseBar() {
      var _this2 = this;
      var div = utils.buildElement('div', ['side-by-side-view__bar']);

      // other X options &#x00D7;&#x2a09;&#x2a2f;
      var btn = utils.buildElement('button', ['side-by-side-view__button-close'], '<span class="side-by-side-view__button-close-cross">&#x2715;</span>' + '<span class="side-by-side-view__button-close-text">Close side by side view</span>', div);
    ...
    value: function createIframe(src) {
      var iframe = utils.buildElement('iframe', ['side-by-side-view__iframe']);
      iframe.src = src;
      return iframe;
    }
  }]);
...
},{"../libs/elife-utils":49}],40:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  function SiteHeader($elm) {
    ...
    var $overlayParent = this.doc.querySelector('.main');
    if (!$overlayParent) {
      return;
    }
    var $overlayFollowingSibling = $overlayParent.firstElementChild;
...
},{"../libs/elife-utils":49,"./MainMenu":26,"./Overlay":32,"./SearchBox":36}],41:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(SpeechBubble, [{
    key: "removePlaceholder",
    value: function removePlaceholder() {
      this.$elm.classList.remove('speech-bubble--has-placeholder');
      var pattern = '\\' + this.placeholder;
      var re = new RegExp(pattern, 'g');
      this.$elm.innerHTML = this.$elm.innerHTML.replace(re, '');
    }
  }, {
    key: "showPlaceholder",
    value: function showPlaceholder(selector) {
      var $replacementTarget = this.$elm.querySelector(selector) || this.$elm;
      $replacementTarget.innerHTML = this.placeholder;
      this.$elm.classList.add('speech-bubble--has-placeholder');
    }
  }, {
    key: "update",
    value: function update(content, selector) {
      this.removePlaceholder();
      var $target = this.$elm.querySelector(selector) || this.$elm;
    ...
    key: "showFailureState",
    value: function showFailureState(applyToParent) {
...
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/_createClass(function StatisticCollection($elm) {
  var _this = this;
  var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
  var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
  _classCallCheck(this, StatisticCollection);
  if (!$elm) {
    return;
  }
  this.$elm = $elm;
  ...
  this.doc = doc;
  this.window.addEventListener('load', function () {
    utils.removeSeparatorFromLastOnLine(_this.$elm, '.statistic-collection__item', 'no-separator');
  });
  this.window.addEventListener('resize', function () {
    utils.removeSeparatorFromLastOnLine(_this.$elm, '.statistic-collection__item', 'no-separator');
  });
...
},{"../libs/elife-utils":49}],43:[function(require,module,exports){
'use strict';
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var SideBySideView = require('./SideBySideView');
module.exports = /*#__PURE__*/function () {
  function TabbedNavigation($elm) {
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, TabbedNavigation);
    this.$elm = $elm;
    this.window = _window;
    this.doc = doc;
    ...
    if (this.sideBySideViewAvailable()) {
      var $header = this.doc.getElementById('siteHeader');
      this.$global = this.doc.querySelector('.global-inner');
      this.sideBySideView = new SideBySideView(this.$global, this.$sideBySide.dataset.sideBySideLink, $header, this.window, this.doc);
      this.openSideBySideListItem();
    }
  }
  return _createClass(TabbedNavigation, [{
    key: "sideBySideViewAvailable",
    value: function sideBySideViewAvailable() {
      var _this = this;
      if (!this.$sideBySide) {
        return false;
      }
      var link = this.$sideBySide.dataset.sideBySideLink;
      if (!link) {
        return false;
      }
      var isLinkProvided = function isLinkProvided() {
        return !!(link && link.match(/^https:\/\/.*$/));
      };
      var isSideBySideViewLikelySupported = function isSideBySideViewLikelySupported() {
        try {
          if (!(_this.window.CSS && _this.window.CSS.supports)) {
            return false;
          }
        } catch (e) {
          return false;
        ...
        return _this.window.CSS.supports('text-orientation', 'sideways') || _this.window.CSS.supports('-webkit-text-orientation', 'sideways');
      };
      return isLinkProvided() && isSideBySideViewLikelySupported();
    }
  }, {
    key: "openSideBySideListItem",
    value: function openSideBySideListItem() {
      var _this2 = this;
      this.$sideBySide.addEventListener('click', function (e) {
        e.preventDefault();
        _this2.sideBySideView.open();
      });
    }
  }]);
}();

},{"./SideBySideView":39}],44:[function(require,module,exports){
'use strict';
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var clipper = require('text-clipper');
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function ToggleableCaption($elm) {
    var _this = this;
    var _window = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
    var doc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
    _classCallCheck(this, ToggleableCaption);
    this.window = _window;
    this.doc = doc;
    ...
    if (this.thresholdWidth !== null) {
      this.toggleToggle();
      this.window.addEventListener('resize', utils.debounce(function () {
        return _this.toggleToggle();
      }, 150));
    } else {
      this.toggleCaption();
    }
  }
  return _createClass(ToggleableCaption, [{
    key: "setupToggle",
    value: function setupToggle() {
      var seeMoreButton = '<button class="caption-text__toggle caption-text__toggle--see-more">see more</button>';
      var seeLessButton = '<button class="caption-text__toggle caption-text__toggle--see-less">see less</button>';
      var fullChildren = [];
      [].forEach.call(this.$caption.childNodes, function (child) {
        return fullChildren.push(child.outerHTML);
      });
      fullChildren = fullChildren.filter(function (child) {
        return child;
      });
      this.originalHtml = fullChildren.join(' ');
      fullChildren.push(seeLessButton);
      var truncatedChildren = fullChildren;
      if (this.$caption.firstElementChild.nodeName.toUpperCase() === 'P') {
        var truncatedChild = truncatedChildren[0];
        try {
        ...
        if (truncatedChild !== truncatedChildren[0] || truncatedChildren.length > 3) {
          truncatedChildren = [truncatedChild.replace(/<\/p>/, " ".concat(seeMoreButton, "</p>"))];
        } else {
          return;
        }
      } else {
    ...
    key: "toggleCaption",
    value: function toggleCaption(e) {
      var $toggle = this.$caption.querySelector('.caption-text__toggle');
...
},{"../libs/elife-utils":49,"text-clipper":148}],45:[function(require,module,exports){
'use strict';
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(Twitter, null, [{
    key: "init",
    value: function init(doc) {
...
module.exports = /*#__PURE__*/function () {
  function ViewSelector($elm) {
    ...
    if (this.isTabSelector) {
      ...
      var classActiveViewSelector = 'view-selector__list-item--active';
      var classDisplayOnNarrow = 'display-narrow';
      this.primarySelector.addEventListener('click', function (e) {
        e.preventDefault();
        _this.selectedSection(classActiveViewSelector, _this.primarySelector, _this.primaryColumn, _this.secondaryColumn, classDisplayOnNarrow);
      });
      this.secondarySelector.addEventListener('click', function (e) {
        e.preventDefault();
        _this.selectedSection(classActiveViewSelector, _this.secondarySelector, _this.secondaryColumn, _this.primaryColumn, classDisplayOnNarrow);
      });
    ...
    if (this.sideBySideViewAvailable()) {
      var $header = this.doc.getElementById('siteHeader');
      this.$global = this.doc.querySelector('.global-inner');
      this.sideBySideView = new SideBySideView(this.$global, this.$elm.dataset.sideBySideLink, $header, this.window, this.doc);
  ...
  return _createClass(ViewSelector, [{
    key: "isViewportWideEnoughForJumpMenu",
    value: function isViewportWideEnoughForJumpMenu() {
      return this.window.matchMedia('(min-width: 1200px)').matches;
    }
    ...
    value: function handleHighlighting(findClosest) {
      var $firstViewableHeading = this.findFirstInView(this.collapsibleSectionHeadings, this.doc, this.window);
      var firstLogicalHeadingText = this.collapsibleSectionHeadings[0] ? this.collapsibleSectionHeadings[0].innerHTML : '';
      var $section = ViewSelector.findSectionForLinkHighlight($firstViewableHeading, firstLogicalHeadingText, findClosest);
      if ($section && typeof $section.id === 'string') {
        var $target = ViewSelector.findLinkToHighlight(this.$jumpLinksList, "[href=\"#".concat($section.id, "\"]"));
        if ($target) {
    ...
    value: function handlePositioning() {
      var bottomOfNav = this.$navDetect.getBoundingClientRect().bottom;
    ...
    value: function sideBySideViewAvailable() {
      var _this2 = this;
      var link = this.$elm.dataset.sideBySideLink;
      var isLinkProvided = function isLinkProvided() {
        return !!(link && link.match(/^https:\/\/.*$/));
      };
      var isSideBySideViewLikelySupported = function isSideBySideViewLikelySupported() {
        try {
          if (!(_this2.window.CSS && _this2.window.CSS.supports)) {
            return false;
          }
        } catch (e) {
          return false;
        ...
        return _this2.window.CSS.supports('text-orientation', 'sideways') || _this2.window.CSS.supports('-webkit-text-orientation', 'sideways');
      };
      return isLinkProvided() && isSideBySideViewLikelySupported();
    }
  }, {
    key: "insertSideBySideListItem",
    value: function insertSideBySideListItem() {
      var _this3 = this;
      var $list = this.doc.querySelector('.view-selector__list');
      var $attachBefore = this.doc.querySelector('.view-selector__list-item--secondary + .view-selector__list-item');
      if (!$attachBefore) {
        return;
      }
      var $listItem = utils.buildElement('li', ['view-selector__list-item', 'view-selector__list-item--side-by-side'], '', $list, $attachBefore);
      var $link = utils.buildElement('a', ['view-selector__link', 'view-selector__link--side-by-side'], '<span>Side by side</span>', $listItem);
      $link.setAttribute('href', this.$elm.dataset.sideBySideLink);
      $link.addEventListener('click', function (e) {
        e.preventDefault();
        _this3.sideBySideView.open();
      });
      return $listItem;
    }
  }, {
    key: "selectedSection",
    value: function selectedSection(classSelector, clickedElement, visibleArea, hiddenArea, classDisplayOnNarrow) {
      this.addActiveClass(classSelector, clickedElement);
      this.showSelectedArea(visibleArea, hiddenArea, classDisplayOnNarrow);
    }
  }, {
    key: "addActiveClass",
    value: function addActiveClass(classSelector, clickedElement) {
      var activeElement = this.$elm.querySelector('.' + classSelector);
      activeElement.classList.remove(classSelector);
      clickedElement.parentNode.classList.add(classSelector);
    }
  }, {
    key: "showSelectedArea",
    value: function showSelectedArea(visibleArea, hiddenArea, classDisplayOnNarrow) {
      visibleArea.classList.remove(classDisplayOnNarrow);
      hiddenArea.classList.add(classDisplayOnNarrow);
    }
  }, {
    key: "hideInactiveSectionInitially",
    value: function hideInactiveSectionInitially(primaryColumn, secondaryColumn, classActiveViewSelector, classDisplayOnNarrow) {
    ...
    key: "updateHighlighting",
    value: function updateHighlighting($target, jumpLinksList) {
      ViewSelector.clearJumpLinkHighlight(jumpLinksList);
      ViewSelector.highlightJumpLink($target);
    }
  }, {
    key: "findSectionForLinkHighlight",
    value: function findSectionForLinkHighlight($heading, firstHeadingText, findClosest) {
      if (!$heading) {
        return;
      }
    ...
    key: "clearJumpLinkHighlight",
    value: function clearJumpLinkHighlight(jumpLinksList) {
      var linksList = [].slice.call(jumpLinksList);
    ...
    key: "highlightJumpLink",
    value: function highlightJumpLink($jumpLink) {
      $jumpLink.classList.add('view-selector__jump_link--active');
    }
  }]);
}();

},{"../libs/elife-utils":49,"./SideBySideView":39}],47:[function(require,module,exports){
"use strict";
...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(ViewerModal, [{
    key: "build",
...
var utils = require('../libs/elife-utils')();
module.exports = /*#__PURE__*/function () {
  function Dismissible($toDismiss, attachPoint, document) {
    _classCallCheck(this, Dismissible);
  ...
  return _createClass(Dismissible, [{
    key: "hasPreviouslyBeenDismissed",
    value: function hasPreviouslyBeenDismissed(cookieName, cookies) {
      return utils.getCookieValue(cookieName, cookies) === 'true';
    }
  }, {
    key: "hasCookieName",
    value: function hasCookieName(cookieName) {
      return cookieName && cookieName.length;
    }
  }, {
    key: "buildButton",
    value: function buildButton($parent) {
      var $button = utils.buildElement('button', ['dismiss-button'], '', $parent);
    ...
    value: function setCookie() {
      if (this.cookieName && this.cookieName.length) {
        this.doc.cookie = "".concat(this.cookieName, "=true; expires=").concat(this.cookieExpiryDate, "; path=/;");
      }
    }
  }, {
    key: "hide",
    ...
    key: "setCookieExpiryDate",
    value: function setCookieExpiryDate($elm) {
      if ($elm.dataset.cookieExpires) {
        return $elm.dataset.cookieExpires;
      }
    }
  }, {
    key: "deriveCookieName",
    value: function deriveCookieName($elm) {
      var cookieNameRoot = $elm.dataset.cookieNameRoot;
      if ($elm.id && $elm.id.length && cookieNameRoot && cookieNameRoot.length) {
        return "".concat(cookieNameRoot).concat($elm.id);
      }
      return '';
    }
  }]);
...
},{"../libs/elife-utils":49}],49:[function(require,module,exports){
"use strict";
...
module.exports = function () {
    ...
    if ($parent) {
      if ($followingSibling) {
        if ($followingSibling.parentNode !== $parent) {
          throw new ReferenceError('Trying to attach an element with respect to an element sibling, but the two elements do not share a common parent.');
        }
  ...
  var uniqueIds = function uniqueIds() {
    /** @class */
    var UniqueIdentifiers = /*#__PURE__*/function () {
      /** @constructor */
       ...
       * @return {boolean}
       */
      return _createClass(UniqueIdentifiers, [{
        key: "isValid",
        value: function isValid(candidate, document) {
          ...
          if (!!document) {
            if (!!document.getElementById && typeof document.getElementById === 'function' && document.getElementById(candidate)) {
              return false;
            }
          }
          return true;
  ...
  function _getValueFromPxString(pxString) {
    ...
    var numberFromString = parseFloat(pxString);
    if (isNaN(numberFromString)) {
      throw new Error("Can't parse argument as a float: ".concat(pxString));
    }
  ...
  function invertPxString(pxString) {
    var adjustedSize = _getValueFromPxString(pxString) * -1;
    return _getZeroAwarePxStringFromValue(adjustedSize);
  }
  ...
  function isIdOfOrWithinSection(id, $section, doc) {
    ...
    var $fragWithId = doc.getElementById(id);
  ...
  function loadJavaScript(uri) {
    var integrity = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  ...
  function flatten(input) {
    var _ref;
    return (_ref = []).concat.apply(_ref, _toConsumableArray(input));
  }
  function remoteDoc(url, window) {
    ...
    if (!(url in window.remoteDocuments)) {
      window.remoteDocuments[url] = loadData(url).then(function (data) {
  ...
  function wrapElements($el, tag, className, styles, fn) {
    var $children = Array.isArray($el) ? $el : [$el];
    var classNames = Array.isArray(className) ? className : [className];
    var $container = buildElement(tag, classNames);
    if (styles) {
  ...
  function create$pageOverlay($parent, $followingSibling, id) {
    ...
    var $overlay = buildElement('div', ['overlay', 'hidden'], '', $parent, $followingSibling);
    if (id) {
      $overlay.id = id;
    }
    return $overlay;
  ...
  function isTopInView($elm, doc, win) {
    ...
    return rect.top >= 0 && rect.top <= (win.innerHeight || html.clientHeight) && rect.left >= 0 && rect.left <= (win.innerWidth || html.clientWidth);
  }
  ...
  function throttle(fn) {
    var thresholdInMs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 250;
    var last;
    var deferTimer;
    return function () {
      var now = +new Date();
  ...
  function isCollapsibleArticleSection($elm) {
    return $elm.dataset && $elm.dataset.behaviour && $elm.dataset.behaviour.indexOf('ArticleSection') > -1;
  }
  ...
  function getItemType($elm) {
    ...
    var $target = $elm.querySelector('[data-item-type]');
    if ($target) {
  ...
  function expandCollapsedSections(parent) {
    var collapsed = parent.querySelectorAll('.article-section--collapsed');
    [].slice.call(collapsed).forEach(function ($section) {
  ...
  function calcScrollbarWidth() {
    ...
    var widthWhenNoScrollBars = inner.offsetWidth;
    outer.style.overflow = 'scroll';
    var widthWhenScrollBars = inner.offsetWidth;
  ...
  function getCookieValue(cookieSought, cookies) {
    ...
    cookies.split('; ').forEach(function (cookie) {
      if (cookie.indexOf(cookieSought) === 0) {
        var re = new RegExp("".concat(cookieSought, "=([^;]*)"));
        var cookieMatch = cookie.match(re)[1];
  ...
  function removeSeparatorFromLastOnLine($elm, itemClassName, separatorClassName) {
    var items = $elm.querySelectorAll(itemClassName);
    if (items.length <= 2) {
      return;
    }
  ...
  function toggleSeparatorClass(items, separatorClassName, isFirstRun) {
    ...
    items.forEach(function (item, index) {
      if (index < items.length - 1 && item.getBoundingClientRect().x >= items[index + 1].getBoundingClientRect().x) {
...
},{"core-js/es6/promise":52,"core-js/es6/set":53,"core-js/fn/object/assign":54,"core-js/fn/symbol":55,"core-js/fn/symbol/iterator":56,"element-closest":146}],51:[function(require,module,exports){
'use strict';
...
var Elife = function Elife() {
  ...
  function initialiseComponent($component) {
    var inputBehaviour = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var behaviour = inputBehaviour ? inputBehaviour : $component.getAttribute('data-behaviour');

    // When present, data-behaviour contains a space-separated list of handlers for that component
    var handlers = behaviour.trim().split(' ');
  ...
  if (components) {
    [].forEach.call(components, function (el) {
      return initialiseComponent(el);
    });
  }
  if ('MutationObserver' in window) {
    var observer = new MutationObserver(function () {
      var components = document.querySelectorAll('[data-behaviour]:not([data-behaviour-initialised])');
      if (components) {
        [].forEach.call(components, function (el) {
          return initialiseComponent(el);
        });
...
},{"../modules/_core":66,"../modules/es6.object.to-string":138,"../modules/es6.promise":139,"../modules/es6.string.iterator":141,"../modules/web.dom.iterable":145}],53:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/es6.string.iterator');
require('../modules/web.dom.iterable');
...
},{"../modules/_core":66,"../modules/es6.object.to-string":138,"../modules/es6.set":140,"../modules/es6.string.iterator":141,"../modules/web.dom.iterable":145}],54:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/_core').Object.assign;

},{"../../modules/_core":66,"../../modules/es6.object.assign":137}],55:[function(require,module,exports){
...
},{"../../modules/_core":66,"../../modules/es6.object.to-string":138,"../../modules/es6.symbol":142,"../../modules/es7.symbol.async-iterator":143,"../../modules/es7.symbol.observable":144}],56:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/_wks-ext').f('iterator');

},{"../../modules/_wks-ext":133,"../../modules/es6.string.iterator":141,"../../modules/web.dom.iterable":145}],57:[function(require,module,exports){
...
},{"./_hide":79,"./_wks":134}],59:[function(require,module,exports){
...
},{"./_is-object":87}],61:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-absolute-index":123,"./_to-iobject":125,"./_to-length":126}],62:[function(require,module,exports){
...
},{"./_cof":63,"./_wks":134}],63:[function(require,module,exports){
...
},{"./_an-instance":59,"./_ctx":67,"./_descriptors":69,"./_for-of":75,"./_iter-define":90,"./_iter-step":92,"./_meta":95,"./_object-create":99,"./_object-dp":100,"./_redefine-all":113,"./_set-species":116,"./_validate-collection":131}],65:[function(require,module,exports){
'use strict';
...
},{"./_an-instance":59,"./_export":73,"./_fails":74,"./_for-of":75,"./_global":77,"./_inherit-if-required":82,"./_is-object":87,"./_iter-detect":91,"./_meta":95,"./_redefine":114,"./_redefine-all":113,"./_set-to-string-tag":117}],66:[function(require,module,exports){
...
},{"./_a-function":57}],68:[function(require,module,exports){
...
},{"./_global":77,"./_is-object":87}],71:[function(require,module,exports){
...
},{"./_object-gops":105,"./_object-keys":108,"./_object-pie":109}],73:[function(require,module,exports){
var global = require('./_global');
...
},{"./_core":66,"./_ctx":67,"./_global":77,"./_hide":79,"./_redefine":114}],74:[function(require,module,exports){
...
},{"./_an-object":60,"./_ctx":67,"./_is-array-iter":85,"./_iter-call":88,"./_to-length":126,"./core.get-iterator-method":135}],76:[function(require,module,exports){
module.exports = require('./_shared')('native-function-to-string', Function.toString);

},{"./_shared":119}],77:[function(require,module,exports){
...
},{"./_descriptors":69,"./_object-dp":100,"./_property-desc":112}],80:[function(require,module,exports){
var document = require('./_global').document;
...
},{"./_descriptors":69,"./_dom-create":70,"./_fails":74}],82:[function(require,module,exports){
var isObject = require('./_is-object');
...
},{"./_is-object":87,"./_set-proto":115}],83:[function(require,module,exports){
...
},{"./_an-object":60}],89:[function(require,module,exports){
'use strict';
var create = require('./_object-create');
...
},{"./_hide":79,"./_object-create":99,"./_property-desc":112,"./_set-to-string-tag":117,"./_wks":134}],90:[function(require,module,exports){
'use strict';
...
},{"./_export":73,"./_hide":79,"./_iter-create":89,"./_iterators":93,"./_library":94,"./_object-gpo":106,"./_redefine":114,"./_set-to-string-tag":117,"./_wks":134}],91:[function(require,module,exports){
var ITERATOR = require('./_wks')('iterator');
...
},{"./_fails":74,"./_has":78,"./_is-object":87,"./_object-dp":100,"./_uid":129}],96:[function(require,module,exports){
var global = require('./_global');
...
},{"./_cof":63,"./_global":77,"./_task":122}],97:[function(require,module,exports){
'use strict';
...
},{"./_a-function":57}],98:[function(require,module,exports){
'use strict';
...
},{"./_descriptors":69,"./_fails":74,"./_iobject":84,"./_object-gops":105,"./_object-keys":108,"./_object-pie":109,"./_to-object":127}],99:[function(require,module,exports){
...
},{"./_an-object":60,"./_dom-create":70,"./_enum-bug-keys":71,"./_html":80,"./_object-dps":101,"./_shared-key":118}],100:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":60,"./_descriptors":69,"./_ie8-dom-define":81,"./_to-primitive":128}],101:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
var getKeys = require('./_object-keys');
...
},{"./_an-object":60,"./_descriptors":69,"./_object-dp":100,"./_object-keys":108}],102:[function(require,module,exports){
var pIE = require('./_object-pie');
var createDesc = require('./_property-desc');
var toIObject = require('./_to-iobject');
var toPrimitive = require('./_to-primitive');
...
},{"./_descriptors":69,"./_has":78,"./_ie8-dom-define":81,"./_object-pie":109,"./_property-desc":112,"./_to-iobject":125,"./_to-primitive":128}],103:[function(require,module,exports){
...
},{"./_object-gopn":104,"./_to-iobject":125}],104:[function(require,module,exports){
...
},{"./_enum-bug-keys":71,"./_object-keys-internal":107}],105:[function(require,module,exports){
...
},{"./_has":78,"./_shared-key":118,"./_to-object":127}],107:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":61,"./_has":78,"./_shared-key":118,"./_to-iobject":125}],108:[function(require,module,exports){
...
},{"./_enum-bug-keys":71,"./_object-keys-internal":107}],109:[function(require,module,exports){
...
},{"./_an-object":60,"./_is-object":87,"./_new-promise-capability":97}],112:[function(require,module,exports){
...
},{"./_core":66,"./_function-to-string":76,"./_global":77,"./_has":78,"./_hide":79,"./_uid":129}],115:[function(require,module,exports){
...
},{"./_an-object":60,"./_ctx":67,"./_is-object":87,"./_object-gopd":102}],116:[function(require,module,exports){
'use strict';
var global = require('./_global');
var dP = require('./_object-dp');
var DESCRIPTORS = require('./_descriptors');
...
},{"./_descriptors":69,"./_global":77,"./_object-dp":100,"./_wks":134}],117:[function(require,module,exports){
...
},{"./_has":78,"./_object-dp":100,"./_wks":134}],118:[function(require,module,exports){
...
},{"./_core":66,"./_global":77,"./_library":94}],120:[function(require,module,exports){
...
},{"./_a-function":57,"./_an-object":60,"./_wks":134}],121:[function(require,module,exports){
...
},{"./_defined":68,"./_to-integer":124}],122:[function(require,module,exports){
var ctx = require('./_ctx');
...
},{"./_cof":63,"./_ctx":67,"./_dom-create":70,"./_global":77,"./_html":80,"./_invoke":83}],123:[function(require,module,exports){
var toInteger = require('./_to-integer');
var max = Math.max;
var min = Math.min;
...
},{"./_defined":68,"./_iobject":84}],126:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":68}],128:[function(require,module,exports){
...
},{"./_is-object":87}],129:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_global":77}],131:[function(require,module,exports){
var isObject = require('./_is-object');
...
},{"./_core":66,"./_global":77,"./_library":94,"./_object-dp":100,"./_wks-ext":133}],133:[function(require,module,exports){
...
},{"./_global":77,"./_shared":119,"./_uid":129}],135:[function(require,module,exports){
...
},{"./_classof":62,"./_core":66,"./_iterators":93,"./_wks":134}],136:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":58,"./_iter-define":90,"./_iter-step":92,"./_iterators":93,"./_to-iobject":125}],137:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./_export');

$export($export.S + $export.F, 'Object', { assign: require('./_object-assign') });

},{"./_export":73,"./_object-assign":98}],138:[function(require,module,exports){
'use strict';
...
},{"./_classof":62,"./_redefine":114,"./_wks":134}],139:[function(require,module,exports){
'use strict';
var LIBRARY = require('./_library');
var global = require('./_global');
var ctx = require('./_ctx');
...
},{"./_a-function":57,"./_an-instance":59,"./_classof":62,"./_core":66,"./_ctx":67,"./_export":73,"./_for-of":75,"./_global":77,"./_is-object":87,"./_iter-detect":91,"./_library":94,"./_microtask":96,"./_new-promise-capability":97,"./_perform":110,"./_promise-resolve":111,"./_redefine-all":113,"./_set-species":116,"./_set-to-string-tag":117,"./_species-constructor":120,"./_task":122,"./_user-agent":130,"./_wks":134}],140:[function(require,module,exports){
'use strict';
...
},{"./_collection":65,"./_collection-strong":64,"./_validate-collection":131}],141:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":90,"./_string-at":121}],142:[function(require,module,exports){
'use strict';
...
},{"./_an-object":60,"./_descriptors":69,"./_enum-keys":72,"./_export":73,"./_fails":74,"./_global":77,"./_has":78,"./_hide":79,"./_is-array":86,"./_is-object":87,"./_library":94,"./_meta":95,"./_object-create":99,"./_object-dp":100,"./_object-gopd":102,"./_object-gopn":104,"./_object-gopn-ext":103,"./_object-gops":105,"./_object-keys":108,"./_object-pie":109,"./_property-desc":112,"./_redefine":114,"./_set-to-string-tag":117,"./_shared":119,"./_to-iobject":125,"./_to-object":127,"./_to-primitive":128,"./_uid":129,"./_wks":134,"./_wks-define":132,"./_wks-ext":133}],143:[function(require,module,exports){
require('./_wks-define')('asyncIterator');

},{"./_wks-define":132}],144:[function(require,module,exports){
require('./_wks-define')('observable');

},{"./_wks-define":132}],145:[function(require,module,exports){
...
},{"./_global":77,"./_hide":79,"./_iterators":93,"./_object-keys":108,"./_redefine":114,"./_wks":134,"./es6.array.iterator":136}],146:[function(require,module,exports){
